  ...
  return (
    <>
      <form onSubmit={handleSubmit(submitProfileForm)} className="space-y-6">
        {/* Profile Information */}
        <div className="my-10 flex flex-col gap-y-6 rounded-md border border-richblack-700 bg-richblack-800 p-8 sm:p-6">
          <h2 className="text-lg font-semibold text-richblack-5">Profile Information</h2>
          <div className="flex flex-col text-richblack-5 gap-5 lg:flex-row">
          ...
          <div className="flex flex-col gap-5 text-richblack-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
